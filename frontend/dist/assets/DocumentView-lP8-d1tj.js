...
`).map(e=>{let t=/^(#{2,3})\s+(.+)$/.exec(e.trim());return t?{id:Hr(t[2]),level:t[1].length,title:t[2]}:null}).filter(Boolean),Jr={id:`main-content`,class:`docs-shell`},Yr={class:`docs-sidebar`,"aria-labelledby":`docs-sidebar-title`},Xr={class:`docs-sidebar-inner`},Zr={class:`sidebar-groups`},Qr={class:`sidebar-nav`},$r={class:`docs-article`,"aria-labelledby":`document-title`},ei={class:`docs-header`},ti={class:`eyebrow`},ni={id:`document-title`},ri=[`innerHTML`],ii={class:`page-nav`,"aria-label":`Documentation page navigation`},ai={class:`article-aside`,"aria-labelledby":`article-toc-title`},oi={class:`article-aside-inner`},si={class:`aside-section`},ci={class:`aside-label`},li={class:`reading-time`},ui={class:`aside-section`},di={id:`article-toc-title`},fi={class:`article-toc`},pi=[`href`],mi=u({__name:`DocumentView`,setup(u){let{t:f}=h(),_=ie(),v=s(()=>te(_)),x=s(()=>_.meta?.docCollection||`rustminersystem`),S=s(()=>_.meta?.docPage||g),C=s(()=>se(x.value)),ae=s(()=>C.value.reduce((e,t)=>{let n=t.category||`guide`;return{...e,[n]:[...e[n]||[],t]}},{})),le=s(()=>re.filter(e=>e.collection===x.value&&ae.value[e.id]?.length)),ue=s(()=>oe(v.value,S.value,x.value)),w=s(()=>ue.value.replace(/^#\s+.+(?:\r?\n)+/,``)),de=s(()=>Kr(w.value)),fe=s(()=>qr(w.value)),T=s(()=>y(S.value,v.value,x.value).title),pe=s(()=>y(S.value,v.value,x.value).description),E=s(()=>ce(S.value,x.value)),me=s(()=>C.value[E.value-1]),he=s(()=>C.value[E.value+1]),ge=s(()=>{let e=w.value.replace(/```[\s\S]*?```/g,``).replace(/[#>*_`[\]()|-]/g,` `).trim().split(/\s+/).filter(Boolean).length;return Math.max(1,Math.ceil(e/220))});return(s,u)=>(e(),p(`main`,Jr,[a(`aside`,Yr,[a(`div`,Xr,[a(`div`,Zr,[(e(!0),p(r,null,m(le.value,s=>(e(),p(`section`,{key:s.id,class:`sidebar-group`},[a(`h2`,null,o(i(ee)(s.id,v.value,x.value).title),1),a(`nav`,Qr,[(e(!0),p(r,null,m(ae.value[s.id]||[],r=>(e(),t(i(ne),{key:r.id,to:i(b)(r.id,v.value,x.value),class:c([`sidebar-link`,{"is-active":r.id===S.value}])},{default:l(()=>[n(o(i(y)(r.id,v.value,x.value).navTitle),1)]),_:2},1032,[`to`,`class`]))),128))])]))),128))])])]),a(`article`,$r,[a(`header`,ei,[a(`p`,ti,o(i(f)(`document.eyebrow`)),1),a(`h1`,ni,o(T.value),1),a(`p`,null,o(pe.value),1)]),a(`section`,{class:`document-content`,"aria-label":`Documentation content`,innerHTML:de.value},null,8,ri),a(`nav`,ii,[me.value?(e(),t(i(ne),{key:0,class:`page-nav-link`,to:i(b)(me.value.id,v.value,x.value)},{default:l(()=>[a(`span`,null,o(i(f)(`document.previousPage`)),1),n(` `+o(i(y)(me.value.id,v.value,x.value).navTitle),1)]),_:1},8,[`to`])):d(``,!0),he.value?(e(),t(i(ne),{key:1,class:`page-nav-link is-next`,to:i(b)(he.value.id,v.value,x.value)},{default:l(()=>[a(`span`,null,o(i(f)(`document.nextPage`)),1),n(` `+o(i(y)(he.value.id,v.value,x.value).navTitle),1)]),_:1},8,[`to`])):d(``,!0)])]),a(`aside`,ai,[a(`div`,oi,[a(`section`,si,[a(`p`,ci,o(i(f)(`document.readingTime`)),1),a(`p`,li,o(i(f)(`document.readingTimeValue`,{minutes:ge.value})),1)]),a(`section`,ui,[a(`h2`,di,o(i(f)(`document.onThisPage`)),1),a(`nav`,fi,[(e(!0),p(r,null,m(fe.value,t=>(e(),p(`a`,{key:t.id,class:c([`toc-link`,`toc-link-level-${t.level}`]),href:`#${t.id}`},o(t.title),11,pi))),128))])])])])]))}},[[`__scopeId`,`data-v-0f6403c6`]]);export{mi as default};