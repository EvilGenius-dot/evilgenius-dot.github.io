...
export default {
    ...
    download: {
        ...
        pages: {
            ...
            cli: {
                title: "Скачать RustMinerSystem CLI",
                heading: "RustMinerSystem CLI",
                description:
                    "RustMinerSystem CLI — это плагин командной строки для RustMinerSystem, созданный для пользователей, которые не хотят использовать web-панель управления. CLI еще не опубликован, поэтому эта страница пока показывает назначение, сценарии применения и будущую точку загрузки.",
            },
        },
        cli: {
            comingSoonBadge: "Плагин еще не опубликован",
            downloadKicker: "Плагин командной строки",
            downloadTitle: "Для управления без web-панели",
            downloadDescription:
                "Некоторые пользователи избегают управления через браузер из-за правил безопасности, сетевой изоляции или привычного рабочего процесса. RustMinerSystem CLI будет предоставлять основные функции управления как плагин командной строки, чтобы статус и базовые операции можно было выполнять из терминала сервера.",
            visual: {
                label: "Превью инструмента командной строки RustMinerSystem CLI",
                alt: "Анимированное превью терминала RustMinerSystem CLI",
                badge: "RustMinerSystem CLI",
                title: "Управление прямо из терминала",
                description:
                    "Подходит для серверных терминалов, jump host и изолированных сред, где нужно уменьшить web-поверхность или использовать привычный CLI-процесс.",
            },
            status: {
                title: "CLI-инструмент готовится",
                description:
                    "После релиза здесь появятся пакеты для Linux и Windows, команды установки и сведения о версии. Сейчас страница объясняет назначение плагина и целевые сценарии.",
            },
            command: {
                ariaLabel: "Превью команд RustMinerSystem CLI",
            ...
            features: {
                terminal: {
                    title: "Управление из терминала",
                    text: "Запускайте проверки, смотрите статус и выполняйте базовые операции из терминала сервера с меньшей зависимостью от web-панели.",
                },
                security: {
                    title: "Для изолированного доступа",
                    text: "Если web-панель нужно скрыть, жестко ограничить или оставить только во внутренней сети, CLI может стать более узкой точкой управления.",
                },
                operations: {
                    title: "Удобно для автоматизации",
                    text: "В будущих версиях CLI сможет использоваться для scripted checks, batch-задач и диагностики в привычном серверном workflow.",
                },
            },
        },
        rustMinerApp: {
