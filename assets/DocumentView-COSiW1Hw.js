...
| Field | Description |
| --- | --- |
| \`id\` | Port ID. Keep the existing value when editing an existing port. |
...
| Field | Description |
| --- | --- |
| \`id\` | Wallet configuration ID. Keep the existing value when editing an existing record. |
| \`server_id\` | Related port or service ID. Usually keep the existing value. |
...
| Поле | Описание |
| --- | --- |
| \`id\` | ID порта. При редактировании существующего порта сохраняйте старое значение. |
...
| Поле | Описание |
| --- | --- |
| \`id\` | ID wallet-настройки. При редактировании существующей записи сохраняйте старое значение. |
| \`server_id\` | Связанный port или service ID. Обычно сохраняется без изменений. |
...
| 字段 | 说明 |
| --- | --- |
| \`id\` | 钱包配置 ID。已有记录建议保留原值。 |
| \`server_id\` | 关联的端口或服务 ID。修改已有记录时通常保留。 |
| \`addr\` | 钱包名称或钱包标识。 |
| \`device\` | 设备名称。 |
