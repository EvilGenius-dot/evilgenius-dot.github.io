...
Paid custom editions of RustMinerSystem can use a Scriptable-based iOS widget. It is not a separately sold plugin. It is a home-screen companion for paid custom editions, giving customers a quick view of their own custom-edition summary statistics.
...
Платные custom-версии RustMinerSystem могут использовать iOS widget на базе Scriptable. Это не отдельный продаваемый plugin, а companion для платной custom-версии, который дает клиенту быстрый просмотр краткой статистики своей версии на домашнем экране iPhone.
...
付费定制版 RustMinerSystem 可以使用基于 Scriptable 的 iOS 小组件。它不是单独销售的插件，而是配套付费定制版提供的手机桌面入口，用于让客户快速查看自己定制版的简易统计。

![定制版 iOS 小组件预览](/image/custom-ios-widget/preview.jpg)

*小组件会在 iPhone 桌面展示在线设备、待审核、客户端数量、币种设备数、算力和趋势。*
